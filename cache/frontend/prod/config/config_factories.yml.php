...
// date: 2018/01/30 17:31:27
  ...
  'cache_dir' => '/home/sshweb/www/citation-et-proverbe.fr/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/sshweb/www/citation-et-proverbe.fr/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/sshweb/www/citation-et-proverbe.fr/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/home/sshweb/www/citation-et-proverbe.fr/apps/frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 587,
      'encryption' => 'tls',
      'username' => 'AKIAJZ6Z5HJHLTA67VXA',
      'password' => 'ArL1+8Cz1poWV0nBL4U1b0rC4hGG+8oVadr86UnVEIrw',
    ),
  ),
))));
