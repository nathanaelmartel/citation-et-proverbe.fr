 ...
 * @method string getWikipediaBio()    Returns the current record's "wikipedia_bio" value
 * @method string getWikipediaUrl()    Returns the current record's "wikipedia_url" value
 ...
 * @method Author setWikipediaBio()    Sets the current record's "wikipedia_bio" value
 * @method Author setWikipediaUrl()    Sets the current record's "wikipedia_url" value
...
abstract class BaseAuthor extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('wikipedia_bio', 'string', null, array(
             'type' => 'string',
             'length' => '',
             ));
        $this->hasColumn('wikipedia_url', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             ));
